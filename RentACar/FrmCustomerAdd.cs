    ...
    public partial class FrmCustomerAdd : Form
    {
       ...
       private bool CheckAllFields()
        ...
        private void bSave_Click(object sender, EventArgs e)
        {
            ...
            string qry_add = "INSERT INTO TblMusteri (TC, Ad, Soyad, Telefon, Email, Adres, LisansNumarasi, DogumTarihi, GirisTarihi, Durumu) VALUES (@TC, @Ad, @Soyad, @Telefon, @Email, @Adres, @LN, @DT, @GT, @Durumu)";
            ...
            cmdAdd.Parameters.AddWithValue("@GT", DateTime.Parse(DtTarih.Text));
